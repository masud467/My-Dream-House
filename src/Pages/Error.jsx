...
const Error = () => {
    return (
        <div>
            <Helmet>
                <title>My Dream House | error</title>
            </Helmet>
	...
	<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
		<div className="max-w-md text-center">
			...
			<Link to='/'>
            <a rel="noopener noreferrer" href="#" className="px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50 btn btn-primary">Back to homepage</a>
            </Link>
		</div>
	</div>
</section>
